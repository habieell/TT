...
import { makeAuthRequest } from "../../actions/authActions";

import { ToastContainer, toast } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";

const LoginPage = () => {
  const { dispatch, authErrorMsg, authData } = useContext(AuthContext);
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-element">
                ...
                <input
                  ...
                  type="text"
                  id="username"
                  onChange={(event) => formDataHandler(event, "username")}
              ...
              <div className="form-element">
                ...
                <input
                  ...
                  type="password"
                  id="password"
                  onChange={(event) => formDataHandler(event, "password")}
